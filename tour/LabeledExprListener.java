...
public interface LabeledExprListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link LabeledExprParser#clear}.
	 * @param ctx the parse tree
	 */
	void enterClear(@NotNull LabeledExprParser.ClearContext ctx);
	/**
	 * Exit a parse tree produced by {@link LabeledExprParser#clear}.
	 * @param ctx the parse tree
	 */
	void exitClear(@NotNull LabeledExprParser.ClearContext ctx);
